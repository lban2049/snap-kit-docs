...
SnapKit 由三个核心模块组成，每个模块都专注于特定的功能领域。本文档介绍这三个模块的概览和主要功能。
...
SnapKit Blocklet 是主应用程序，提供完整的 Web 界面和 API 服务。它是用户与 SnapKit 交互的主要入口点。
...
详细信息请参考：[SnapKit Blocklet 详细文档](modules/blocklet.md)

## 2. Crawler Engine

### 概述

Crawler Engine 是 SnapKit 的核心自动化引擎，基于 Puppeteer 构建，负责实际的网页访问、截图和内容提取。
...
SnapKit Blocklet 内部集成了 Crawler Engine，通过以下方式协作：
...
其他 Blocklet 应用可以使用 SEO Middleware 连接到 SnapKit：
...
- [SnapKit Blocklet 详细文档](modules/blocklet.md)
